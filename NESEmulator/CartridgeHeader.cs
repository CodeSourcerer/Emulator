...
namespace NESEmulator
{
    public struct CartridgeHeader
    {
        ...
        public byte chr_ram_size;
        public byte tv_system1;
        public char[] unused;

        public CartridgeHeader(byte prg_rom_chunks, byte chr_rom_chunks,
            byte mapper1, byte mapper2, byte prg_ram_size, byte chr_ram_size,
            byte tv_system1, char[] name = null, char[] unused = null)
        {
            ...
            this.chr_ram_size = chr_ram_size;
